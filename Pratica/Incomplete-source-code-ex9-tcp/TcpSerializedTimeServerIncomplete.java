    ...
    public static void main(String args[]){
        ...
        try(ServerSocket socket = new ServerSocket(Integer.parseInt(args[0]))){
            ...
            while(true){
                ...
                InetAddress currentClientAddr = null;
                ...
                try(Socket toClientSocket = socket.accept();
                    ...
                    currentClientAddr = toClientSocket.getInetAddress();
                    currentClientPort = toClientSocket.getPort();
                    ...
                    System.out.println("Problema na comunicacao com o cliente " + 
                            currentClientAddr.getHostAddress() + ":" +
                            currentClientPort+"\n\t" + e);
                }
            }
